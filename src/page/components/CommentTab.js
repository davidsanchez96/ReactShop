        ...
        return (
            <View style={styles.tabBar}>
                <TouchableOpacity style={styles.tabItem} activeOpacity={0.6}
                                  onPress={() => msg.emit('goods:changeState', {commentsType: '3'})}>
                    <Text
                ...
                <TouchableOpacity style={styles.tabItem} activeOpacity={0.6}
                                  onPress={() => msg.emit('goods:changeState', {commentsType: '0'})}>
                    <Text
                ...
                <TouchableOpacity style={styles.tabItem} activeOpacity={0.6}
                                  onPress={() => msg.emit('goods:changeState', {commentsType: '1'})}>
                    <Text
                ...
                <TouchableOpacity style={styles.tabItem} activeOpacity={0.6}
                                  onPress={() => msg.emit('goods:changeState', {commentsType: '2'})}>
                    <Text
