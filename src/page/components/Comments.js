        ...
        <TouchableOpacity style={styles.box} activeOpacity={1} onPress={() => this._handleToGoodComments()}>
          ...
          <View style={styles.rowItem}>
            <Text style={{marginRight: 20}} allowFontScaling={false}>好评度&nbsp;<Text
              style={{color: '#e63a59'}} allowFontScaling={false}>{this.props.product.get('commentPercent')}</Text></Text>
            <Text style={{color: '#666'}} allowFontScaling={false}>{this.props.product.get('commentCount')}人评论</Text>
          </View>
